...
class MLPPlotter2D:
    ...
    def create_controls(self):
        controls = {name:self.create_slider(name) for name in ['w_x_0', 'w_y_0', 'b_0', 'w_x_1', 'w_y_1', 'b_1', 'w_h_0', 'w_h_1', 'b_h']}

        controls['activation_function_index'] = widgets.Dropdown(
            options={list(self.activation_functions_dict.keys())[i]:i for i in range(len(self.activation_functions_dict))},
            value=1,
    ...
    def plot_interactive(self, w_x_0, w_y_0, b_0, w_x_1, w_y_1, b_1, w_h_0, w_h_1, b_h, activation_function_index):
